...
class AuthorController extends AbstractController
{
    ...
    public function createAuthor(Request $request,EntityManagerInterface $em,SerializerInterface $serializer,ValidatorInterface $validate,TagAwareCacheInterface $cach):JsonResponse
    {
