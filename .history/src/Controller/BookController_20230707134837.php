...
class BookController extends AbstractController
{
    ...
    public function updateBooks(Request $request,EntityManagerInterface $em,SerializerInterface $serializer,Book $currentBook,ValidatorInterface $validate,AuthorRepository $authorRepository,T):JsonResponse
    {
