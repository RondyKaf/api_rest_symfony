...
class BookController extends AbstractController
{
    ...
    public function getDetailBooks(int $id,Book $book,SerializerInterface $serializer):JsonResponse
    {
        $context = SerializationContext::create()->setGroups(["getBooks"]);
    ...
    public function updateBooks(Request $request,EntityManagerInterface $em,SerializerInterface $serializer,Book $currentBook,ValidatorInterface $validate,AuthorRepository $authorRepository,TagAwareCacheInterface $cache):JsonResponse
    {
